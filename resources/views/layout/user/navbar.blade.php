      ...
      <nav class="navbar navbar-expand-md py-3 navbar-light bg-white shadow rounded mt-3 mb-5">
          <a class="navbar-brand span font-weight-bold" href="{{ route('home') }}"><img width="80px" height="30px" src="{{ asset('assets/imgs/logo/lastilnkdard.png') }}" alt="@lang('concept.ILNK')"></a>
